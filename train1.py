...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default = '/home/u6da/taotl.u6da/FM-OSD/output', required=False)
    ...
    parser.add_argument('--dataset_pth', type=str, default = '/home/u6da/taotl.u6da/FM-OSD/data/Cephalometric/', required=False, help='data path')
