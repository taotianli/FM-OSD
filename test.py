...
def find_landmark_all(extractor, device, model_post, image_path1: str, dataloader, lab, load_size: int = 224, layer: int = 9,
    ...
    with open("/home/u6da/taotl.u6da/FM-OSD/results/ours_head_topk3.json", "w") as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default = '/home/u6da/taotl.u6da/FM-OSD/output', required=False, help='The root save dir for results.')
    ...
    # 
    parser.add_argument('--dataset_pth', type=str, default = '/home/u6da/taotl.u6da/FM-OSD/data/Cephalometric/', required=False, help='data root')
    ...
    iter_num = 0
    # load models
    model_path = '/home/u6da/taotl.u6da/FM-OSD/models/model_post_fine_iter_20.pth'
    model_post.load_state_dict(torch.load(model_path))

    # load global model
    model_dict = model_post.state_dict()

    global_model_path = '/home/u6da/taotl.u6da/FM-OSD/models/model_post_iter_9450.pth'
